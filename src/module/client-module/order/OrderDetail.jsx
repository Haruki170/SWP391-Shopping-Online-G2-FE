              ...
              <Stack direction={"row"} spacing={1} sx={{ alignItems: "start" }}>
                ...
                <Stack>
                  ...
                  <p className="shop-address mb-0">
                    Đơn hàng có {item.orderList.length} sản phẩm từ{" "}
                    {item.shop.name}
                  </p>
                </Stack>
              </Stack>
            ...
            <Box sx={{ marginTop: "20px", marginBottom: "10px" }}>
              ...
              {item.orderList.map((itemList) => {
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <Stack>
                        ...
                        <Stack direction={"row"} spacing={1} className="mt-2">
                          <Typography
                            className="option option-general"
                            variant="body1"
                            color="initial"
                          >
                            Option:
                          ...
                          <Typography
                            className="option-item option-general-item"
                            variant="body1"
                            color="initial"
                          >
                        ...
                        <Stack direction={"row"} spacing={1} className="mt-2">
                          {itemList.productAddOns.length != 0 && (
                            <>
                              ...
                              <Typography
                                className="addon-item option-general-item"
                                variant="body1"
                                color="initial"
                              >
                                {itemList.productAddOns
                    ...
                    <Stack
                      direction={"row"}
                      sx={{ justifyContent: "space-between", width: "40%" }}
                    >
                      <Stack>
                      ...
                      <Stack>
                        <Typography  className="item-general" sx={{ fontWeight: "bold" }}>
                          {itemList.productAddOns.length !== 0
                            ...
                            : formatCurrency(
                                itemList.product.price * itemList.quantity
                              )}
                        </Typography>
                      </Stack>
                    </Stack>
              ...
              >
                ...
                >
                  ...
                  >
                    <g clip-path="url(#clip0_1185_122641)">
                      <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
                    ...
                    <defs>
                      <clipPath id="clip0_1185_122641">
                        <rect width="23.2487" height="16" fill="white"></rect>
                      </clipPath>
                    </defs>
                  </svg>
              ...
              >
                ...
                {item.shipCost == 0 && (
                  <Typography
                    ...
                    color="initial"
                  >
                    (Cửa hàng sẽ liên hệ báo giá sau khi bạn đặt hàng thành
                    công)
                  </Typography>
                )}
                ...
                {item.shipCost == 2 ? (
                  <Typography
                    ...
                    color="initial"
                  >
                    (Đây chỉ là giá ước tính, có thể đơn hàng sẽ liên hệ để báo
                    giá chính xác)
                  </Typography>
                ) : (
                  ""
